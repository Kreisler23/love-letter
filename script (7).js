...
========================================================= */
const MONTHSARRY_DATE = "2026-06-14T04:30:00"; // <-- change to your real start date
...
function startLoveCounter(){
  ...
  function update(){
    ...
    // tiny pulse on the seconds box each tick, so it visibly reads as "live"
    const secondsBox = els.s.closest(".counter-box");
    if (secondsBox){
      secondsBox.classList.remove("tick");
      void secondsBox.offsetWidth; // restart animation
